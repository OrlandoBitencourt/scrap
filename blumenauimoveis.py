...
def scrap(apartamentos: list) -> list:
    page = requests.get('https://www.blumenauimoveis.com.br/imoveis?pretensao=comprar&tipos=1&cidade=4202404&bairros=3'
                        '0579%2C30552%2C30578%2C30573%2C36166%2C30576&valor_min=0&valor_max=200.000&ordem=menor-valor')
    ...
    print(colored("Bluemenauimoveis ok", "green"))
    return apartamentos
